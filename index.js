...
function createList() {
	...
	// run locally
    $.get("http://localhost:7071/api/chantelleRestaurant", function(data, status){ 
    
    
	// run on Azure
    // $.get("https://chantellerestaurant.azurewebsites.net/api/chantellerestaurant", function(data, status){ 
